...
void RenderOGLScene()
{
 ...
 //   // Accept fragment if it is closer to the camera than the former one
	...
	//glm::mat4 Projection = glm::perspective(glm::radians(40.0f),  1136.0f/534.0f, 1.0f, 10000.0f);   //-15.0f
	//// Camera matrix
	//glm::mat4 View = glm::lookAt(
	//	glm::vec3(0, 1000, 3000), // Camera is at (0,3,5), in World Space
 ...
 //   GLuint programID = LoadShaders("TransformVertexShader.vertexshader", "TextureFragmentShader.fragmentshader");
	...
	//	  1000.0f,0.0f, 1000.0f,    1.0f, 1.0f, // Top Right
	//	 -1000.0f,0.0f,-1000.0f,    0.0f, 0.0f, // Bottom Right
	//	  1000.0f,0.0f,-1000.0f,    1.0f, 0.0f, // Bottom Left
	//	  1000.0f,0.0f, 1000.0f,    1.0f, 1.0f  // Top Left 
