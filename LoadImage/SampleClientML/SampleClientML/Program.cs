...
{
    public partial class SampleClientML:Form
    {
        ...
        static void Main()
        {
            ...
            if (connectionConfirmed)                         // Once the connection is confirmed.
            {
                ...
                Application.Run(new SampleClientML());
            }
        ...
        private void InitializeComponent()
        {
            ...
            this.pictureBox.Size = new System.Drawing.Size(1006, 977);
            ...
            this.Name = "SampleClientML";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "OptiTrack";
            this.Load += new System.EventHandler(this.SampleClientML_Load);
            ((System.ComponentModel.ISupportInitialize)(this.pictureBox)).EndInit();
            this.ResumeLayout(false);

        }

        public SampleClientML()
        {
            InitializeComponent();

        }

        private void SampleClientML_Load(object sender, EventArgs e)
        {
            //read image
        ...
        private void pictureBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.FillEllipse(brush, xpos, ypos, 10, 10);
